...
const SEED = [
  { name: 'Шипяны-АСК', cost: 1200000, effect: 2100000, var_type: 'continuous', score: 1.19, credit_limit: '' },
  { name: 'Достоево', cost: 900000, effect: 1300000, var_type: 'binary', score: 1.21, credit_limit: '' },
  { name: 'ДолжаАгро', cost: 800000, effect: 600000, var_type: 'continuous', score: 0.56, credit_limit: '' },
  { name: 'Криничная', cost: 1000000, effect: 1500000, var_type: 'continuous', score: 1.06, credit_limit: 500000 },
  { name: 'Олекшицы', cost: 700000, effect: 720000, var_type: 'continuous', score: 1.00, credit_limit: '' },
  { name: 'Минскоблагросервис', cost: 850000, effect: 780000, var_type: 'continuous', score: 0.90, credit_limit: '' },
  { name: 'Учхоз БГСХА', cost: 950000, effect: 1350000, var_type: 'continuous', score: 1.08, credit_limit: '' },
]
...
export default function Optimization() {
  ...
  const addRow = () => setRows((rs) => [...rs, { name: '', cost: 0, effect: 0, var_type: 'continuous', score: 0, credit_limit: '' }])
  ...
  async function run() {
    ...
    try {
      const projects = rows.filter((r) => r.name && num(r.cost) > 0).map((r) => ({
        ...
        var_type: r.var_type, score: num(r.score),
